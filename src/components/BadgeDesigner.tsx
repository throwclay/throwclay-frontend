        ...
        <div
          ...
          style={{
            ...
            borderRadius: design.shape === 'circle' ? '50%' :
                         ...
                         design.shape === 'star' ? '0' : '12px',
            clipPath: design.shape === 'hexagon' ? 'polygon(25% 6.7%, 75% 6.7%, 100% 50%, 75% 93.3%, 25% 93.3%, 0% 50%)' :
                     design.shape === 'star' ? 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)' :
                     design.shape === 'diamond' ? 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' : 'none',
            ...gradientStyle,
            ...shadowStyle
          }}
        >
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Create a custom badge for your class completion</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateDesign({ gradientEnabled: checked })}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={([value]) => updateDesign({ borderWidth: value })}
                  max={10}
                  min={0}
                  step={1}
                  className="w-full"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Tabs value={design.iconType} onValueChange={(value: any) => updateDesign({ iconType: value })}>
                ...
                <TabsContent value="predefined" className="space-y-4">
                  <div className="grid grid-cols-4 gap-2">
                    {PREDEFINED_ICONS.map((iconItem) => (
                      <Button
                        key={iconItem.id}
                        variant={design.icon === iconItem.id ? 'default' : 'outline'}
                        size="sm"
                      ...
                      >
                        ...
                        <span className="text-xs text-center leading-tight">{iconItem.name}</span>
                      </Button>
                    ))}
                  </div>
                </TabsContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateDesign({ shadowEnabled: checked })}
                />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                ...
                <Badge variant="secondary" className="capitalize">{design.shape}</Badge>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Icon Type:</span>
                <Badge variant="secondary" className="capitalize">{design.iconType}</Badge>
              </div>
              <div className="flex justify-between">
