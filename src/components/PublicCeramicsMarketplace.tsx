...
export function PublicCeramicsMarketplace() {
    const [ceramics] = useState<CeramicPiece[]>([
        {
            ...
            description:
                "Hand-thrown stoneware dinner set with warm sunset glazes. Perfect for everyday dining or special occasions. Set includes 4 plates, bowls, and mugs.",
            price: 280,
            images: [
        ...
        },
        {
            ...
            description:
                "Elegant celadon vase with subtle crackling. Hand-thrown and finished with traditional celadon glaze. Perfect for fresh flowers or as a standalone piece.",
            price: 85,
            images: [
        ...
        },
        {
            ...
            description:
                "Set of 4 handmade coffee mugs with earthy glazes. Each mug is unique with slight variations. Microwave and dishwasher safe.",
            price: 120,
            images: [
        ...
        },
        {
            ...
            description:
                "Contemporary sculptural bowl with organic form and crystalline glaze. A statement piece for modern interiors.",
            price: 195,
            images: [
    ...
    const filteredCeramics = ceramics
        .filter((piece) => {
            const matchesSearch =
    ...
    const handleContactArtist = (piece: CeramicPiece) => {
        ...
        alert(
            `Contact form for ${piece.artistName} would open here. This would allow buyers to inquire about the piece.`
        );
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mt-16 bg-primary/5 rounded-lg p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                    Join Throw Clay and start selling your ceramics to pottery enthusiasts
                    worldwide.
                </p>
                <Button size="lg">Start Selling Your Ceramics</Button>
            </div>
        </div>
    );
}
