...
import { User, Building2, ArrowLeft, ArrowRight, Check, Mail, Lock, MapPin, Globe, Palette, Calendar, DollarSign, Users, Crown, Zap, Star, Info } from 'lucide-react';
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            {step === 5 && formData.accountType === 'artist' ? 'Start free forever, upgrade anytime' : 'Choose the plan that fits your studio'}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <div className="flex flex-col items-center text-center space-y-3">
                    <div className={`p-4 rounded-full ${
                      formData.accountType === 'artist' ? 'bg-primary text-primary-foreground' : 'bg-muted'
                    }`}>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Track your work, share your portfolio, and connect with studios
                      </p>
                    </div>
                    {formData.accountType === 'artist' && (
                ...
                >
                  <div className="flex flex-col items-center text-center space-y-3">
                    <div className={`p-4 rounded-full ${
                      formData.accountType === 'studio' ? 'bg-primary text-primary-foreground' : 'bg-muted'
                    }`}>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Manage members, classes, kilns, and studio operations
                      </p>
                    </div>
                    {formData.accountType === 'studio' && (
                      <div className="flex items-center gap-2 text-primary">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="name"
                    placeholder={formData.accountType === 'studio' ? 'John Doe' : 'Enter your full name'}
                    value={formData.name}
              ...
              <div className="space-y-2">
                <Label htmlFor="handle">
                  {formData.accountType === 'studio' ? 'Studio Handle' : 'Username'}
                </Label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">@</span>
                  <Input
                    id="handle"
                    placeholder={formData.accountType === 'studio' ? 'clayandfire' : 'johndoe'}
                    value={formData.accountType === 'studio' ? (formData.studioHandle || '') : (formData.artistHandle || '')}
                    onChange={(e) => updateFormData(
                      formData.accountType === 'studio' ? 'studioHandle' : 'artistHandle', 
                ...
                {(errors.artistHandle || errors.studioHandle) && (
                  <p className="text-sm text-destructive">{errors.artistHandle || errors.studioHandle}</p>
                )}
              </div>
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.locationAddress && (
                      <p className="text-sm text-destructive">{errors.locationAddress}</p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {errors.locationPhone && (
                        <p className="text-sm text-destructive">{errors.locationPhone}</p>
                      )}
                    </div>
                  </div>
                </div>
          ...
          {step === 4 && (
            <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="professional">Professional - Teaching or selling work</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => updateFormData('studioType', value)}
                    >
                      <SelectTrigger id="studioType">
                        <SelectValue placeholder="Select studio type" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="community">Community Studio</SelectItem>
                        <SelectItem value="teaching">Teaching Studio</SelectItem>
                        <SelectItem value="production">Production Studio</SelectItem>
                        <SelectItem value="shared">Shared Workspace</SelectItem>
                        <SelectItem value="private">Private Studio</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) => updateFormData('memberCapacity', parseInt(e.target.value) || 50)}
                          className="pl-9"
                        />
                      </div>
                    </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="bio">
                  {formData.accountType === 'studio' ? 'Studio Description' : 'Bio'}
                </Label>
                <Textarea
                  id="bio"
                  placeholder={
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <span className="text-sm text-muted-foreground">
                    Choose a color that represents your {formData.accountType === 'studio' ? 'studio' : 'artistic style'}
                  </span>
                </div>
              </div>
            </div>
              ...
              {formData.accountType === 'artist' ? (
                <>
                  ...
                  <div className="p-6 border-2 border-primary bg-primary/5 rounded-lg">
                    ...
                    <p className="text-muted-foreground mb-4">Perfect for individual artists getting started</p>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-center gap-2">
                        <Check className="size-4 text-primary" />
                        <span className="text-sm">Personal pottery journal</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="size-4 text-primary" />
                        <span className="text-sm">Track up to 50 pieces</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="size-4 text-primary" />
                      ...
                      <li className="flex items-center gap-2">
                        <Check className="size-4 text-primary" />
                        <span className="text-sm">Connect with studios</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="p-6 border-2 border-border rounded-lg hover:border-primary transition-colors">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h3 className="text-xl font-semibold">Pro Artist</h3>
                        </div>
                        <p className="text-3xl font-bold">$12<span className="text-lg font-normal text-muted-foreground">/month</span></p>
                      </div>
                      <Button variant="outline" size="sm" onClick={() => updateFormData('selectedPlan', 'pro')}>
                        Upgrade
                      </Button>
                    </div>
                    <p className="text-muted-foreground mb-4">For professional artists and sellers</p>
                    <ul className="space-y-2 mb-4">
                      <li className="flex items-center gap-2">
                        <Check className="size-4 text-primary" />
                        <span className="text-sm">Unlimited pieces tracking</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="size-4 text-primary" />
                    ...
                    <p className="text-xs text-muted-foreground">You can upgrade anytime from your account settings</p>
                  </div>
                </>
              ) : (
                <>
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      All studio plans include a <strong>7-day limited trial</strong> for setup. During the trial, you won't be able to invite members. Our onboarding team will contact you to schedule a personalized onboarding session and provide ongoing support.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-center gap-2">
                          <Check className="size-4" />
                          <span className="text-sm">Up to 25 members</span>
                        </li>
                        <li className="flex items-center gap-2">
                          <Check className="size-4" />
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-2xl font-bold">$149<span className="text-sm font-normal text-muted-foreground">/mo</span></p>
                        </div>
                        {formData.selectedPlan === 'professional' && (
                          <Check className="size-5 text-primary" />
                        )}
