...
export function PotteryJournal() {
  ...
  const [projects, setProjects] = useState<Project[]>([
    {
      ...
      description:
        "A series of functional bowls exploring different glazing techniques",
      color: "#8B4513",
      createdAt: "2025-06-01T10:00:00Z",
      updatedAt: "2025-06-15T14:30:00Z",
      artistId: currentUser?.id || "user1",
      throwCount: 3,
      isShared: false,
      sharePermissions: [],
      comments: [],
      ...
      sharePermissions: [
        {
          ...
          permission: "comment",
          canDuplicate: false,
          grantedBy: currentUser?.id || "user1",
  ...
  const filteredThrows = throws.filter((entry) => {
    ...
    const matchesProject =
      ...
      (selectedProject === "none"
        ? !entry.projectId
        : entry.projectId === selectedProject);
  ...
  const getSubscriptionBadge = () => {
    ...
    return (
      <Badge
        className={`${colors[subscription as keyof typeof colors]} text-white`}
      >
        {subscription === "free"
          ? "Free"
          ...
          <div className="flex items-center space-x-2">
            <div
              className={`w-2 h-2 rounded-full ${
                subscriptionLimits.canUploadPhotos
                  ? "bg-green-500"
                  : "bg-gray-400"
              }`}
            />
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        ...
        {/* Throws Tab */}
        <TabsContent value="throws" className="space-y-6">
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {subscriptionLimits.canCollaborate && (
                            <DropdownMenuItem
                              onClick={(e) => {
                                e.stopPropagation();
                                setShareTarget({ type: "throw", id: entry.id });
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      {entry.glazes.length > 0 && (
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-muted-foreground">Glazes:</span>
        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              <Label htmlFor="project-description" className="text-right mt-2">
                Description
              </Label>
              <Textarea
      ...
      <Dialog open={showNewThrowDialog} onOpenChange={setShowNewThrowDialog}>
        <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Record the details of your pottery piece. Choose traditional form
              or whiteboard mode for visual documentation.
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setNewThrowData((prev) => ({ ...prev, projectId: value }))
                    }
                  >
                    <SelectTrigger>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-700 mt-1">
                      Your throw will open in a visual whiteboard where you can
                      add photos, sketches, sticky notes, and text. Perfect for
                      documenting your process with visual elements and freeform
                      notes.
                    </p>
      ...
      <Dialog open={showEditThrowDialog} onOpenChange={setShowEditThrowDialog}>
        <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center space-x-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setEditingThrow({ ...editingThrow, potteryType: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setEditingThrow({ ...editingThrow, clayType: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setEditingThrow({ ...editingThrow, firingType: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setEditingThrow({ ...editingThrow, firingTemp: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
