...
export function InvoicePreview({ layout, settings, userName }: InvoicePreviewProps) {
    if (layout === "modern") {
        return (
            <div
                ...
                >
                    <div className="space-y-2">
                        ...
                        <div>
                            ...
                            {settings.website && (
                                <p className="text-sm text-muted-foreground">{settings.website}</p>
                            )}
                        </div>
                    </div>
        ...
        return (
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-8 mb-6">
                    <div>
                        <h4 className="font-bold mb-2 text-sm uppercase tracking-wide">Bill To:</h4>
                        <p className="text-sm">Customer Name</p>
                        <p className="text-sm text-gray-600">customer@example.com</p>
                    </div>
                    <div>
                        <h4 className="font-bold mb-2 text-sm uppercase tracking-wide">From:</h4>
                ...
                {(settings.invoiceTerms || settings.invoiceNotes) && (
                    <div className="space-y-3 mb-6 text-xs border-t-2 border-gray-300 pt-4">
                        ...
                        {settings.invoiceNotes && (
                            <div>
                                <h5 className="font-bold mb-1 uppercase tracking-wide">Notes:</h5>
        ...
        >
            ...
            <div className="flex items-start justify-between mb-12">
                ...
                <div className="text-right space-y-1">
                    ...
                    <p className="text-sm text-gray-500">{settings.invoiceNumberPrefix}-001</p>
                ...
                <div className="space-y-6 mb-12 text-xs">
                    {settings.invoiceTerms && (
                        <div>
                            ...
                            <p className="text-gray-600 leading-relaxed">{settings.invoiceTerms}</p>
                        </div>
                    )}
                    {settings.invoiceNotes && (
                        <div>
                            ...
                            <p className="text-gray-600 leading-relaxed">{settings.invoiceNotes}</p>
                        </div>
                    )}
                </div>
            )}
