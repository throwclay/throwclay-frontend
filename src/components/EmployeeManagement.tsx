  ...
  const [employees] = useState<EmployeeData[]>([
    {
      ...
      managerProfile: {
        ...
        profileImage: 'https://images.unsplash.com/photo-1494790108755-2616b812c8e5?w=200&h=200&fit=crop&crop=face',
        phone: '(503) 555-0100',
        maxVacationDays: 15,
        maxSickDays: 10,
        usedVacationDays: 5,
              ...
              <Tabs defaultValue="employee" className="space-y-4">
                ...
                <TabsContent value="employee" className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {employeeForm.role === 'co-admin' && coAdminCount >= maxCoAdmins && (
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className={`flex items-center space-x-1 text-xs px-2 py-1 rounded-full ${
                        ...
                        availability.status === 'upcoming' ? 'bg-blue-100 text-blue-800' :
                        availability.status === 'finished' ? 'bg-gray-100 text-gray-800' :
                    ...
                    {profile && (
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Hired: {new Date(profile.hiredDate).toLocaleDateString()}</span>
                        </div>
                      </div>
                    )}
                    ...
                    {employee.unfilledResponsibilities.length > 0 && (
                      <div className="p-2 bg-orange-50 border border-orange-200 rounded">
                        <div className="flex items-center space-x-1">
                          <AlertTriangle className="w-4 h-4 text-orange-600" />
                          <span className="text-sm text-orange-800">
                            {employee.unfilledResponsibilities.length} unfilled responsibilities
                          </span>
                        </div>
                      </div>
                    )}
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="covering-shift">Covering Shift</SelectItem>
