...
export function GlazeEditor({ glazeId, onBack, onSave }: GlazeEditorProps) {
  ...
  const commonIngredients = [
    'Potash Feldspar', 'Soda Feldspar', 'Nepheline Syenite', 'Silica', 'Whiting',
    'Kaolin', 'Ball Clay', 'Dolomite', 'Barium Carbonate', 'Zinc Oxide',
    'Iron Oxide', 'Cobalt Carbonate', 'Copper Carbonate', 'Chrome Oxide',
    'Tin Oxide', 'Titanium Dioxide', 'Rutile', 'Manganese Dioxide',
    'Red Iron Oxide', 'Yellow Ochre', 'Bentonite', 'Gerstley Borate',
    'Lithium Carbonate', 'Magnesium Carbonate', 'Talc', 'Bone Ash'
  ];
  ...
  const predefinedTags = [
    'matte', 'glossy', 'crystalline', 'celadon', 'shino', 'tenmoku', 'ash-glaze',
    'copper-red', 'iron-red', 'cobalt-blue', 'chrome-green', 'rutile-blue',
    'high-fire', 'mid-fire', 'low-fire', 'food-safe', 'decorative-only',
    'translucent', 'opaque', 'flowing', 'stable', 'experimental', 'reliable',
    'commercial', 'traditional', 'modern', 'functional', 'artistic'
  ];
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground text-lg">
              {glazeId ? 'Update glaze details and recipe' : 'Create a new glaze experiment or add store-bought glaze'}
            </p>
          </div>
        </div>
              ...
              <div className="grid grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setGlazeForm(prev => ({ ...prev, quantity: parseFloat(e.target.value) || 0 }))}
                    placeholder="500"
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setGlazeForm(prev => ({ ...prev, manufacturer: e.target.value }))}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setGlazeForm(prev => ({ ...prev, productCode: e.target.value }))}
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setGlazeForm(prev => ({ ...prev, testDate: e.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setGlazeForm(prev => ({ ...prev, firedDate: e.target.value }))}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-2">
                  <Input
                    ...
                    onChange={(e) => setGlazeForm(prev => ({ ...prev, imageUrl: e.target.value }))}
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button onClick={handleAddIngredient} disabled={glazeForm.type === 'store-bought'}>
                  ...
                  <div className="grid grid-cols-6 gap-2 max-h-48 overflow-y-auto border rounded-lg p-3">
                    {coneOptions.map(cone => (
                      <div key={cone} className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor={`cone-${cone}`} className="text-xs">
                          {cone}
                        </Label>
                      </div>
                    ))}
                  ...
                  {glazeForm.cone && glazeForm.cone.length > 0 && (
                    <div className="flex flex-wrap gap-1">
                      {glazeForm.cone.map(cone => (
                        <Badge key={cone} variant="secondary" className="text-xs">
                          Cone {cone}
                        </Badge>
                      ))}
                    </div>
