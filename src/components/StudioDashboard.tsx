...
export function StudioDashboard() {
  ...
  const isStudioOwner = context.currentUser?.activeMode === 'studio'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-3xl font-semibold">
                            {context.currentStudio?.memberCount || 24}
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-3xl font-semibold">
                            {context.currentStudio?.classCount || 12}
                        </p>
                    </div>
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center space-x-4">
                                                    ...
                                                    <Progress
                                                        value={
                                                            (firing.bookedSlots / firing.capacity) *
                                                            100
                                                        }
                                                        className="w-24 h-2"
                                                    />
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-4 py-4">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Sarah Wilson joined the studio
                                        </p>
                                ...
                                <div className="flex items-center space-x-4 py-4">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Main kiln finished successfully
                                        </p>
                                ...
                                <div className="flex items-center space-x-4 py-4">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Question about glazing techniques
                                        </p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            {mockKilns.map((kiln) => (
                                <div
                                    key={kiln.id}
                                    className="space-y-6 py-6 border-b"
                                >
                                    <div className="flex items-center justify-between">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="font-medium">
                                                {kiln.lastFired
                                                    ? new Date(kiln.lastFired).toLocaleDateString()
                                                    : "Never"}
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                {
                                    name: "Emma Davis",
                                    action: "Completed wheel throwing class",
                                    time: "2 days ago",
                                    status: "completed"
                                },
                                {
                                    name: "John Smith",
                                    action: "Scheduled firing slot",
                                    time: "3 days ago",
                                    status: "scheduled"
                                }
                            ].map((member, index) => (
