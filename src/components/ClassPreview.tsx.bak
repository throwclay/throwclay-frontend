...
export function ClassPreview({ classData, onBack }: ClassPreviewProps) {
  ...
  const mockClassData = {
    ...classData,
    description: 'Learn the fundamentals of wheel throwing pottery including centering, pulling walls, and basic forms. This comprehensive course covers everything from clay preparation to finishing techniques. Perfect for beginners looking to develop a solid foundation in pottery.',
  ...
  const mockReviews: Review[] = [
    {
      ...
      rating: 5,
      comment: 'Sarah is an amazing instructor! I went from never touching clay to making beautiful bowls. The class atmosphere is so supportive and fun.',
      date: '2 weeks ago'
    },
    {
      id: '2',
      ...
      rating: 5,
      comment: 'Best pottery class I\'ve taken. Great balance of instruction and hands-on practice. Highly recommend for beginners!',
      date: '1 month ago'
    },
    {
      id: '3',
      ...
      rating: 4,
      comment: 'Really enjoyed the class structure. Sarah explains techniques clearly and gives great individual feedback.',
      date: '1 month ago'
    }
  ];
  ...
  const selectedPrice = pricingOptions.find(p => p.id === selectedPricing) || pricingOptions.find(p => p.isDefault);
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-3">
                ...
                <Badge variant={mockClassData.status === 'active' ? 'default' : 'secondary'}>
              ...
              <div className="flex items-center space-x-6 text-muted-foreground">
                <div className="flex items-center space-x-2">
                  <Avatar className="w-8 h-8">
                    <AvatarFallback>{mockClassData.instructor.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                  </Avatar>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">{mockClassData.description}</p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div>
                    ...
                    <p>{mockClassData.duration} • {mockClassData.sessionsPerWeek} sessions per week</p>
                  </div>
                  <div>
                    <h3 className="font-medium text-sm text-muted-foreground">Session Length</h3>
                    <p>{mockClassData.sessionDuration} per session</p>
                  </div>
                  <div>
                    <h3 className="font-medium text-sm text-muted-foreground">Class Size</h3>
                    <p>Maximum {mockClassData.capacity} students</p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div>
                    <h3 className="font-medium text-sm text-muted-foreground">Materials</h3>
                    <p>{mockClassData.materials}</p>
                  </div>
                  <div>
                    <h3 className="font-medium text-sm text-muted-foreground">Prerequisites</h3>
            ...
            <Card className="sticky top-24">
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    {selectedPrice && (
                      <div className="text-xs text-muted-foreground">{selectedPrice.name}</div>
                    )}
                  </div>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {selectedPrice && (
                    <p className="text-xs text-muted-foreground">{selectedPrice.description}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {mockClassData.waitlist > 0 && (
                    <p className="text-xs text-muted-foreground">{mockClassData.waitlist} people on waitlist</p>
                  )}
                </div>
                ...
                >
                  {mockClassData.enrolled >= mockClassData.capacity ? 'Join Waitlist' : 'Enroll Now'}
                </Button>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span>{mockClassData.startDate} - {mockClassData.endDate}</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
      ...
      <Dialog open={showWaitlistDialog} onOpenChange={setShowWaitlistDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This class is currently full. Join the waitlist to be notified when a spot opens up.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="text-sm">Current waitlist position: #{mockClassData.waitlist + 1}</span>
              </div>
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button onClick={() => {
                toast.success('Added to waitlist! We\'ll notify you when a spot opens.');
