...
const colors = [
  ...
  '#8b4513', '#ffc0cb', '#808080', '#a52a2a', '#90ee90'
];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-4 p-4 bg-muted rounded-lg">
        ...
        <Button variant="outline" onClick={clearCanvas} className="flex items-center space-x-2">
      ...
      <div className="flex justify-end space-x-2">
        ...
        <Button onClick={saveDrawing} disabled={!imageLoaded} className="flex items-center space-x-2">
      ...
      <div className="text-sm text-muted-foreground text-center">
        <p>Use your mouse or touch to draw. Select colors and adjust brush size as needed.</p>
        <p>{initialImage ? 'Edit your existing sketch or add new elements.' : 'Perfect for sketching pottery forms, decorative patterns, or process diagrams.'}</p>
      </div>
    </div>
  );
}