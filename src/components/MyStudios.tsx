...
export function MyStudios() {
    ...
    const getKilnStatusBadge = (status: string) => {
        switch (status) {
            ...
            case "firing":
                return <Badge className="bg-orange-500 hover:bg-orange-600">Firing</Badge>;
            case "cooling":
                return <Badge className="bg-purple-500 hover:bg-purple-600">Cooling</Badge>;
            default:
    ...
    const getEmployeeStatusBadge = (status: string) => {
        switch (status) {
            ...
            case "in-class":
                return <Badge className="bg-yellow-500 hover:bg-yellow-600">In Class</Badge>;
            case "busy":
    ...
    return (
        <div className="container max-w-7xl mx-auto p-6 space-y-6 pb-8">
            ...
            <Collapsible
                open={isStudioInfoOpen}
                onOpenChange={setIsStudioInfoOpen}
            >
                <Card
                                ...
                                <div className="space-y-4 border-t pt-4">
                                    {!isActiveMember && (
                                        <Alert>
                                            ...
                                            <AlertDescription>
                                                You are no longer an active member at this studio.
                                                Your membership ended on{" "}
                                                {memberDetails.membershipEnded}. You can view your
                                                payment history and reapply for membership.
                                            </AlertDescription>
                                        </Alert>
                                    )}
                    ...
                    <CardContent className="space-y-6">
                        <Alert>
                            ...
                            <AlertDescription>
                                ...
                                {new Date(memberDetails.membershipEnded!).toLocaleDateString()}. You
                                can view your payment history below and reapply for membership if
                        ...
                        <div className="border-t pt-6">
                            <Button
                                onClick={handleReapplyMembership}
                                className="w-full"
                            >
                ...
                >
                                        ...
                                        {enrolledClasses.slice(0, 1).map((classItem) => (
                                            ...
                                            >
                                                ...
                                                <div className="pt-2 border-t">
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Practice centering - 3 bowls with consistent
                                                        wall thickness
                                                    </p>
                                                </div>
                                            </div>
                    ...
                    >
                                    ...
                                    >
                                        ...
                                        <DialogContent>
                                            <DialogHeader>
                                                ...
                                                <DialogDescription>
                                                    For large quantities or special firing needs,
                                                    submit a request to the studio
                                                </DialogDescription>
                                            </DialogHeader>
                                            <div className="space-y-4">
                                                <div className="space-y-2">
                        ...
                        <Dialog
                            ...
                            onOpenChange={setShowShelfDialog}
                        >
                                ...
                                <ScrollArea className="max-h-[50vh]">
                                    <div className="space-y-2 pr-4">
                                        {journalThrows.map((throwItem) => {
                                            const isSelected = selectedThrows.includes(
                                                throwItem.id
                                            );
                                            return (
                                                <div
