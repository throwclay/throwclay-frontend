                ...
                <Card className="text-center py-12">
                    <CardContent>
                        ...
                        <p className="text-muted-foreground">
                            Please contact support to set up your studio.
                        </p>
                    </CardContent>
                </Card>
            </div>
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <Badge className="bg-blue-100 text-blue-800">{members.length} Active Members</Badge>
            </div>
            ...
            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value: "studio_artist") =>
                                                setNewMember((prev) => ({ ...prev, type: value }))
                                            }
                                        >
                                            <SelectTrigger>
                                                <SelectValue />
                                            ...
                                            <SelectContent>
                                                <SelectItem value="studio_artist">
                                                    Studio Artist
                                                </SelectItem>
                                            </SelectContent>
                                        </Select>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        ...
                                                        {member.name} from the studio? This action
                                                        cannot be undone.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
                ...
                >
                    <div className="flex items-center justify-between">
                        <h2>Glaze Library</h2>
                        <Dialog
                            open={showAddGlazeDialog}
                            onOpenChange={setShowAddGlazeDialog}
                        >
                            <DialogTrigger asChild>
                                <Button className="flex items-center space-x-2">
                                    <Plus className="w-4 h-4" />
                            ...
                            <DialogContent>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-end space-x-2">
                                        <Button
                                            variant="outline"
                                            onClick={() => setShowAddGlazeDialog(false)}
                                        >
                                            Cancel
                                        </Button>
                                        <Button
                                            onClick={handleAddGlaze}
                                            disabled={!newGlaze.trim()}
                                        >
                                            Add Glaze
                                        </Button>
                                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>
                                Available Glazes ({context.currentStudio.glazes.length})
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                ...
                >
                    <div className="flex items-center justify-between">
                        ...
                        <Dialog
                            open={showAddFiringDialog}
                            onOpenChange={setShowAddFiringDialog}
                        >
                            <DialogTrigger asChild>
                                <Button className="flex items-center space-x-2">
                                    <Plus className="w-4 h-4" />
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                setNewFiring((prev) => ({ ...prev, type: value }))
                                            }
                                        >
                                            <SelectTrigger>
                                                <SelectValue />
                                    ...
                                    <div className="flex justify-end space-x-2">
                                        <Button
                                            variant="outline"
                                            onClick={() => setShowAddFiringDialog(false)}
                                        >
                                            Cancel
                                        </Button>
                                        <Button onClick={handleAddFiring}>Schedule Firing</Button>
                                    </div>
                                </div>
                            </DialogContent>
                        </Dialog>
                                        ...
                                        <AlertDialog>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        Are you sure you want to cancel this firing?
                                ...
                                <CardContent>
                                    <div className="space-y-2">
                                        <div className="flex justify-between text-sm">
                                            <span>Capacity:</span>
                                            <span>
                                                {firing.bookedSlots}/{firing.capacity} slots
                                            </span>
                                        </div>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                    Percentage of sales that goes to the studio for hosting the
                                    marketplace
                                </p>
                            </div>
                            ...
                            <div className="p-4 bg-muted rounded-lg">
                                ...
                                <div className="mt-3 pt-2 border-t text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span>
                                            Artist: ${100 - context.currentStudio.commissionRate} |
                                            Studio: ${context.currentStudio.commissionRate}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Members can list their pottery for sale
                                    </p>
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Show studio logo on marketplace
                                    </p>
                                </div>
                                <Switch defaultChecked />
                            </div>
