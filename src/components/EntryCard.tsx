            ...
            {featuredPhoto && (
                <div className="relative aspect-video overflow-hidden rounded-t-lg">
                    ...
                    <div className="absolute top-2 left-2">
                        <Badge
                            variant={featuredPhoto.type === "sketch" ? "default" : "secondary"}
                            className="text-xs"
                        >
            ...
            <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center space-x-2 text-sm">
                            ...
                            {entry.photos.filter((p) => p.type === "sketch").length > 0 && (
                                <Badge
                                    ...
                                    className="text-xs"
                                >
                                    {entry.photos.filter((p) => p.type === "sketch").length}{" "}
                                    sketches
                                </Badge>
                            )}
                        </div>
                ...
                {entry.notes && (
                    <div>
                        ...
                        <p className="text-sm line-clamp-3 text-muted-foreground">{entry.notes}</p>
                    </div>
                )}
