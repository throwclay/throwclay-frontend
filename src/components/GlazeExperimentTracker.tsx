...
export function GlazeExperimentTracker({ onNavigateToEditor }: GlazeExperimentTrackerProps) {
  ...
  const handleExport = (format: 'csv' | 'excel') => {
    console.log(`Exporting ${selectedItems.length || filteredGlazes.length} items as ${format}`);
  };
    ...
    <div className="max-w-7xl mx-auto p-8 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-lg">Track and manage your glaze recipes, experiments, and inventory</p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <Select value={filterAtmosphere} onValueChange={setFilterAtmosphere}>
            <SelectTrigger className="w-40">
          ...
          <TableHeader>
            <TableRow>
              <TableHead className="w-12">
                <Checkbox
                  checked={selectedItems.length === filteredGlazes.length && filteredGlazes.length > 0}
              ...
              <TableRow key={glaze.id}>
                <TableCell>
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleSelectItem(glaze.id, checked as boolean)}
                  />
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  {glaze.testDate ? new Date(glaze.testDate).toLocaleDateString() : '-'}
                </TableCell>
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuItem onClick={() => onNavigateToEditor(glaze.id)}>
        ...
        <div className="text-center py-16 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              {searchTerm || filterStatus !== 'all' || filterType !== 'all' || filterAtmosphere !== 'all'
