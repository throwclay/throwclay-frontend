...
import { User, Camera, Edit, Save, ExternalLink, Instagram, Globe, Twitter, Facebook, Trophy, Award, Star, Grid3X3, Heart, MessageCircle, Share, Settings, MoreHorizontal, MapPin, Calendar, Users, Copy, Check, ShoppingBag, GraduationCap, BookOpen, Clock, DollarSign, Phone, Mail, Navigation } from 'lucide-react';
...
import { useAppContext, type ArtistProfile as ArtistProfileType, type StudentBadge } from '@/app/context/AppContext';
...
export function ArtistProfile() {
  ...
  const mockBadges: StudentBadge[] = [
    {
      ...
      instructorNotes: 'Excellent progress throughout the course. Mastered wheel throwing fundamentals with exceptional attention to detail.',
    ...
    },
    {
      ...
      instructorNotes: 'Demonstrated advanced understanding of glaze chemistry and application techniques.',
      displayOnProfile: true
    }
  ];
  ...
  const mockPosts = [
    { id: 1, image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=400&fit=crop', likes: 124, comments: 18, title: 'Morning wheel session with our intermediate students', date: '2025-01-10' },
    { id: 2, image: 'https://images.unsplash.com/photo-1465408953385-7c4627c2d4a6?w=400&h=400&fit=crop', likes: 89, comments: 12, title: 'Exploring new glaze combinations in our test kiln', date: '2025-01-08' },
    { id: 3, image: 'https://images.unsplash.com/photo-1595475116879-45f4495e6db5?w=400&h=400&fit=crop', likes: 156, comments: 24, title: 'Fresh pieces from our weekend intensive workshop', date: '2025-01-06' },
    { id: 4, image: 'https://images.unsplash.com/photo-1593826988276-b9d8e3b74282?w=400&h=400&fit=crop', likes: 67, comments: 8, title: 'Behind the scenes: Loading the large reduction kiln', date: '2025-01-05' },
    { id: 5, image: 'https://images.unsplash.com/photo-1543254382-96cd0c0b8746?w=400&h=400&fit=crop', likes: 203, comments: 31, title: 'Student showcase: Amazing texture work by Lisa', date: '2025-01-03' },
    { id: 6, image: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=400&h=400&fit=crop', likes: 112, comments: 15, title: 'Raku firing session - always magical results', date: '2025-01-01' },
  ];

  // Mock shop items for studio
  const mockShopItems = [
    { id: 1, name: 'Handcrafted Ceramic Bowl', price: 45, image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=300&h=300&fit=crop', artist: 'Sarah Martinez', inStock: true },
    { id: 2, name: 'Glazed Pottery Mug Set', price: 65, image: 'https://images.unsplash.com/photo-1465408953385-7c4627c2d4a6?w=300&h=300&fit=crop', artist: 'Mike Chen', inStock: true },
    { id: 3, name: 'Decorative Vase - Blue Glaze', price: 89, image: 'https://images.unsplash.com/photo-1595475116879-45f4495e6db5?w=300&h=300&fit=crop', artist: 'Elena Rodriguez', inStock: false },
    { id: 4, name: 'Ceramic Planter Set', price: 120, image: 'https://images.unsplash.com/photo-1593826988276-b9d8e3b74282?w=300&h=300&fit=crop', artist: 'David Kim', inStock: true },
    { id: 5, name: 'Artisan Dinner Plates', price: 180, image: 'https://images.unsplash.com/photo-1543254382-96cd0c0b8746?w=300&h=300&fit=crop', artist: 'Lisa Park', inStock: true },
    { id: 6, name: 'Raku Fired Bowl', price: 95, image: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=300&h=300&fit=crop', artist: 'Tom Wilson', inStock: true },
  ];
  ...
  const mockClasses = [
    { 
      ...
      description: 'Learn the fundamentals of wheel throwing in our comprehensive 6-week course.',
      price: 280, 
      duration: '6 weeks', 
      level: 'Beginner',
    ...
    { 
      ...
      description: 'Explore advanced glazing methods including layering, crystalline, and reduction techniques.',
      price: 320, 
      duration: '4 weeks', 
      level: 'Advanced',
      image: 'https://images.unsplash.com/photo-1465408953385-7c4627c2d4a6?w=400&h=250&fit=crop',
    ...
    { 
      ...
      description: 'Master coil, slab, and pinch techniques in this hands-on workshop series.',
      price: 350, 
      duration: '5 weeks', 
      level: 'Intermediate',
      image: 'https://images.unsplash.com/photo-1595475116879-45f4495e6db5?w=400&h=250&fit=crop',
  ...
  const mockBlogPosts = [
    {
      ...
      excerpt: 'Discover the magical process of raku firing and how it creates unique, unpredictable glazes that have captivated ceramicists for centuries.',
    ...
    },
    {
      ...
      excerpt: 'Understanding the different properties of clay bodies and how to select the perfect one for your specific pottery goals.',
      image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=250&fit=crop',
      author: 'Mike Chen',
      date: '2025-01-05',
      readTime: '6 min read',
    ...
    },
    {
      ...
      excerpt: 'Meet some of our amazing students and learn about their pottery journeys, from first wheel session to confident ceramic artists.',
      image: 'https://images.unsplash.com/photo-1543254382-96cd0c0b8746?w=400&h=250&fit=crop',
              ...
              <div className="flex justify-center lg:justify-start">
                <div className="relative group">
                  <Avatar className="w-40 h-40 border-4 border-background shadow-xl">
                    <AvatarImage src={editedProfile.profileImage} className="object-cover" />
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                  <div className="space-y-1">
                    <h1 className="text-2xl md:text-3xl font-light tracking-tight">{currentUser.name}</h1>
                ...
                <div className="flex justify-center lg:justify-start">
                  <div className="flex space-x-8 md:space-x-12">
                    <div className="text-center">
                      <div className="text-xl md:text-2xl font-semibold">{mockPosts.length}</div>
                      <div className="text-sm text-muted-foreground">posts</div>
                    </div>
                    {isStudio ? (
                      <>
                        <div className="text-center">
                          <div className="text-xl md:text-2xl font-semibold">250+</div>
                          <div className="text-sm text-muted-foreground">members</div>
                        </div>
                        <div className="text-center">
                          <div className="text-xl md:text-2xl font-semibold">12</div>
                      ...
                      <>
                        <div className="text-center">
                          <div className="text-xl md:text-2xl font-semibold">2.8k</div>
                          <div className="text-sm text-muted-foreground">followers</div>
                        </div>
                        <div className="text-center">
                          <div className="text-xl md:text-2xl font-semibold">312</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {!isStudio && mockBadges.filter(b => b.status === 'active').length > 0 && (
                      <Badge variant="default" className="flex items-center space-x-1 text-xs">
                        <Trophy className="w-3 h-3" />
                        <span>{mockBadges.filter(b => b.status === 'active').length}</span>
                      </Badge>
                    )}
                  </div>
                  ...
                  {isEditing ? (
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder={isStudio ? "Tell people about your studio..." : "Tell people about your pottery journey..."}
                        rows={3}
              ...
              <TabsList className="bg-transparent border-none h-auto p-0 w-full justify-center">
                ...
                {isStudio ? (
                  ...
                  >
                    ...
                    BADGES ({mockBadges.filter(b => b.status === 'active').length})
                  </TabsTrigger>
                )}
              </TabsList>
            </div>
              ...
              <div className="text-center py-16 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Start sharing your pottery journey! Upload photos of your latest creations and connect with the community.
                  </p>
                </div>
                <Button>
                      ...
                      <div className="md:flex">
                        ...
                        <CardContent className="md:w-2/3 p-6">
                          <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                <span className="font-semibold text-lg">${classItem.price}</span>
                                <p className="text-xs text-muted-foreground">{classItem.spotsLeft} spots left</p>
                              </div>
                              <Button>
                                Enroll Now
                              </Button>
              ...
              {mockBadges.length > 0 ? (
                        ...
                        <CardContent className="p-4 text-center space-y-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              Grade: {badge.finalGrade}% • Attendance: {badge.finalAttendance}%
                            </p>
                          </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2">
                        {Array.from(new Set(mockBadges.flatMap(b => b.skillsAchieved))).map((skill) => (
                ...
                <div className="text-center py-16 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground max-w-md mx-auto">
                      Complete classes and achieve learning milestones to earn badges that showcase your pottery skills.
                    </p>
                  </div>
                </div>
              )}
