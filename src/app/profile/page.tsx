...
import type { User as UserType, ArtistProfile as ArtistProfileType, StudentBadge } from "@/types";
...
export default function ArtistProfile({ onProfileUpdated }: ArtistProfileProps) {
    ...
    const mockPosts = [
        ...
        {
            id: 2,
            image: "https://images.unsplash.com/photo-1465408953385-7c4627c2d4a6?w=400&h=400&fit=crop",
            likes: 89,
            comments: 12,
        ...
        {
            id: 3,
            image: "https://images.unsplash.com/photo-1595475116879-45f4495e6db5?w=400&h=400&fit=crop",
            likes: 156,
            comments: 24,
        ...
        {
            id: 4,
            image: "https://images.unsplash.com/photo-1593826988276-b9d8e3b74282?w=400&h=400&fit=crop",
            likes: 67,
            comments: 8,
        ...
        {
            id: 5,
            image: "https://images.unsplash.com/photo-1543254382-96cd0c0b8746?w=400&h=400&fit=crop",
            likes: 203,
            comments: 31,
    ...
    const mockShopItems = [
        ...
        },
        {
            ...
            price: 65,
            image: "https://images.unsplash.com/photo-1465408953385-7c4627c2d4a6?w=300&h=300&fit=crop",
            artist: "Mike Chen",
            inStock: true
        },
        {
            ...
            price: 89,
            image: "https://images.unsplash.com/photo-1595475116879-45f4495e6db5?w=300&h=300&fit=crop",
        ...
        },
        {
            ...
            price: 120,
            image: "https://images.unsplash.com/photo-1593826988276-b9d8e3b74282?w=300&h=300&fit=crop",
            artist: "David Kim",
            inStock: true
        },
        {
            ...
            price: 180,
            image: "https://images.unsplash.com/photo-1543254382-96cd0c0b8746?w=300&h=300&fit=crop",
            artist: "Lisa Park",
            inStock: true
        },
        {
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <div className="flex flex-wrap gap-2">
                                                {Array.from(
                                                    new Set(
                                                        mockBadges.flatMap((b) => b.skillsAchieved)
                                                    )
                                                ).map((skill) => (
                                                    <Badge
                                                        key={skill}
