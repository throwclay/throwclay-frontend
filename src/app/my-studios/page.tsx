...
export default function MyStudios() {
    ...
    const [selectedGlazeForReport, setSelectedGlazeForReport] = useState<string | null>(null);
                                                ...
                                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                                    ...
                                                    <div className="flex gap-2">
                                                        {kiln.yourPieces > 0 ? (
                                                            ...
                                                            <Button
                                                                disabled={kiln.spotsAvailable === 0}
                                                            >
                                                                Reserve Spot
                                                            </Button>
                                                        )}
