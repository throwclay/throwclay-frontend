...
export default function LoginForm(props: LoginFormProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (authMode === "login") {
                ...
                props.onLogin({ email, phone, session: data.session });
            } else {
                // --- SIGNUP FLOW ---
    ...
    const title =
        authMode === "login"
            ? "Welcome Back"
            : "Create your Throw Clay account";
    const subtitle =
        authMode === "login"
    ...
    return (
        <div className="flex flex-grow items-center justify-center bg-gradient-to-br from-stone-50 to-amber-50 p-4">
