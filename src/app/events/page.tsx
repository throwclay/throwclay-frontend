...
export default function EventsManagement() {
    ...
    const [events, setEvents] = useState<Event[]>([
        {
            ...
            description:
                "Showcase your finest ceramic works in our annual summer exhibition. All studio members are invited to participate.",
            type: "exhibition",
            date: "2025-07-15",
            endDate: "2025-07-30",
            ...
            requirements: [
                "Must be studio member for 3+ months",
                "Maximum 3 pieces per artist",
                "Professional quality work only"
            ],
            pricing: {
                participationFee: 50,
                commissionRate: 20
        ...
        },
        {
            ...
            description:
                "Set up your booth and sell your pottery directly to the public. Great opportunity for emerging artists.",
            type: "sale",
            date: "2025-06-28",
            endDate: "2025-06-29",
        ...
        },
        {
            ...
            description:
                "Community raku firing event. Bring your glazed pieces and experience this ancient Japanese technique.",
            type: "workshop",
            date: "2025-07-05",
        ...
        },
        {
            ...
            description:
                "Submit your best work for the annual regional ceramics competition. Winners receive cash prizes and exhibition opportunities.",
            type: "competition",
            date: "2025-08-15",
        ...
        setEvents((prev) =>
            prev.map((e) =>
                e.id === event.id
                    ? {
                          ...e,
                          currentParticipants: [...e.currentParticipants, context.currentUser.id]
                      }
                    : e
            )
        );
    ...
    const canManageEvents =
        context.currentUser?.type === "studio_admin" || context.currentUser?.type === "instructor";
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Discover pottery events, exhibitions, and opportunities to showcase your
                        work
                    </p>
                </div>
                            ...
                            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <Label htmlFor="participation-fee">
                                                Participation Fee ($)
                                            </Label>
                                            <Input
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                Allow non-studio members to participate
                                            </p>
                                        </div>
                                        <Switch
                        ...
                        >
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2 text-sm">
                                    ...
                                    {event.pricing?.participationFee !== undefined &&
                                        event.pricing.participationFee > 0 && (
                                            <div className="flex items-center space-x-2">
                                                <DollarSign className="w-4 h-4 text-muted-foreground" />
                                                <span>
                                                    ${event.pricing.participationFee} participation
                                                    fee
                                                </span>
                                            </div>
                                        )}
                                ...
                                <div className="flex flex-wrap gap-2 pt-2">
                                    ...
                                    {canManageEvents &&
                                        event.organizerId === context.currentUser?.id && (
                                            <>
                                                <Button
                                                    variant="outline"
                                                    size="sm"
