        ...
        <div className="flex items-center justify-between p-3 bg-card border-t">
            <div className="flex items-center space-x-2">
                ...
                <Button
                    ...
                    disabled={currentPage >= (currentThrow?.whiteboardPages.length || 1) - 1}
                >
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-1">
                                        {availableGlazes.map((glaze) => (
                                            <Badge
                                                ...
                                                className="cursor-pointer text-xs"
                                                onClick={() => {
                                                    const newGlazes = currentThrow.glazes.includes(
                                                        glaze
                                                    )
                                                        ? currentThrow.glazes.filter(
                                                              (g) => g !== glaze
                                                          )
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span>{new Date(currentThrow.date).toLocaleDateString()}</span>
                                </div>
                            </div>
                        </div>
                    </TabsContent>
