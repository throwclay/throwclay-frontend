...
export default function WhiteboardEditor() {
    ...
    const handleScheduleFiring = () => {
        ...
        const selectedSchedule = availableFirings.find((f) => f.id === selectedFiring);
            ...
            const suggestions = trimmingPatterns
                .filter((pattern) => {
                    ...
                    if (context.currentThrow?.potteryType === "Bowl") {
                        ...
                        return ["traditional-foot", "minimal-trim", "textured-rim"].includes(
                            pattern.id
                        );
                    }
                    return true;
    ...
    const renderToolbar = () => (
        <div className="flex items-center justify-between p-4 bg-card border-b sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-2">
                ...
                <Button
                    size="sm"
                    onClick={() => updateThrow(context.currentThrow)}
                >
        ...
        <div className="flex items-center space-x-2 p-3 bg-card border-b overflow-x-auto">
            ...
            <div className="flex items-center space-x-1">
                {potteryProcesses.slice(0, 4).map((process) => {
                    const isEnhanced = ["glazing", "firing", "trimming"].includes(process.id);
                    return (
                        <Button
                            key={process.id}
                            variant="ghost"
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-1">
                                        {techniques.slice(0, 6).map((technique) => (
                                            <Badge
                                                key={technique}
                                                variant={
                                                    context.currentThrow.techniques.includes(
                                                        technique
                                                    )
                                                        ? "default"
                                                        : "outline"
                                                ...
                                                onClick={() => {
                                                    const newTechniques =
                                                        context.currentThrow.techniques.includes(
                                                            ...
                                                            : [
                                                                  ...currentThrow.techniques,
                                                                  technique
                                                              ];
                                                    handleUpdateThrowField(
                                                        "techniques",
                                                        newTechniques
                                                    );
                                                }}
                                        ...
                                        {availableGlazes.map((glaze) => (
                                            <Badge
                                                ...
                                                onClick={() => {
                                                    const newGlazes =
                                                        context.currentThrow.glazes.includes(glaze)
                                                            ? context.currentThrow.glazes.filter(
                                                                  (g) => g !== glaze
                                                              )
                                                            : [
                                                                  ...context.currentThrow.glazes,
                                                                  glaze
                                                              ];
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span>
                                        {new Date(
                                            context.currentThrow.createdAt
                                        ).toLocaleDateString()}
                                    </span>
                                </div>
                                <div className="flex items-center justify-between">
                                    ...
                                    <span>
                                        {new Date(
                                            context.currentThrow.updatedAt
                                        ).toLocaleDateString()}
                                    </span>
                                </div>
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-blue-700 mt-1">
                                                Based on your{" "}
                                                {context.currentThrow?.potteryType?.toLowerCase() ||
                                                    "piece"}{" "}
