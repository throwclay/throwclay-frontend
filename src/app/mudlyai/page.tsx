...
import { MudlyLogo } from './MudlyLogo'
...
export function MudlyAI() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hi there! I'm Mudly, your pottery studio AI agent! 🎨 I can help you with studio management, pottery techniques, glaze recipes, kiln schedules, and much more. How can I help you today?",
      timestamp: new Date()
    }
  ]);
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          const aiMessage: Message = {
            id: (Date.now() + 1).toString(),
            role: 'assistant',
            content: "I heard your question about fixing cracks! For greenware, you can use slip and scoring. For bisqueware, you'll need a different approach. Would you like detailed instructions?",
            timestamp: new Date(),
            isAudio: true
          };
          setMessages(prev => [...prev, aiMessage]);
      ...
      setMessages([
        {
          id: '1',
          role: 'assistant',
          content: "Hi there! I'm Mudly, your pottery studio AI assistant! 🎨 How can I help you today?",
          timestamp: new Date()
        }
      ]);
    }
  ...
  const handleDislike = (messageId: string) => {
    setMessages(prev => prev.map(msg => 
      msg.id === messageId 
        ? { ...msg, feedback: 'disliked' as const }
        : msg
    ));
  ...
  return (
    <>
      ...
      {!isOpen && (
        <div className={`fixed ${getPositionClasses()} z-50`}>
            <Button
                ...
                >
                <MudlyLogo
                    className="size-14 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none"
                />
      ...
      {isOpen && (
        <div className={`fixed ${getPositionClasses()} z-50`}>
          <Card className={`${isMinimized ? 'w-80' : 'w-96'} shadow-2xl transition-all duration-300`}>
            {/* Header */}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        We never share your personal information or studio data with third parties. 
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Studio optimization suggestions</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Kiln schedules, deadlines, etc.</p>
                        </div>
                      </div>
                      <Switch defaultChecked />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Updates to Mudly's capabilities</p>
                        </div>
                      </div>
                      <Switch defaultChecked />
                    </div>
