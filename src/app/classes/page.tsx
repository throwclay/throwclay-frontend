...
export default function ArtistClasses() {
  ...
  const mockAvailableClasses: ClassData[] = [
    {
      ...
      price: 320,
      status: 'upcoming',
      description: 'Learn the fundamentals of wheel throwing in this comprehensive beginner course. Perfect for those new to pottery.',
      ...
      pricingTiers: [
        { id: '1', name: 'Early Bird', price: 280, description: 'Save $40 with early registration', isDefault: false },
        { id: '2', name: 'Standard', price: 320, description: 'Regular class price', isDefault: true },
        { id: '3', name: 'Premium', price: 380, description: 'Includes take-home clay package', isDefault: false }
      ],
      discountCodes: [
        { id: '1', code: 'FIRSTTIME20', type: 'percentage', value: 20, description: 'First-time student discount' }
      ]
    },
    {
      id: '2',
      ...
      price: 280,
      status: 'upcoming',
      description: 'Master advanced glazing techniques including layering, reduction firing, and custom glaze formulation.',
      ...
      pricingTiers: [
        { id: '1', name: 'Standard', price: 280, description: 'Workshop fee', isDefault: true }
      ],
      discountCodes: []
    },
    {
      ...
      price: 240,
      status: 'upcoming',
      description: 'Explore handbuilding techniques including coil, slab, and pinch methods for creating unique ceramic pieces.',
      ...
      pricingTiers: [
        { id: '1', name: 'Standard', price: 240, description: 'Regular class price', isDefault: true }
      ],
      discountCodes: []
    },
    {
      ...
      price: 290,
      status: 'upcoming',
      description: 'A gentle introduction to pottery making, covering both wheel throwing and handbuilding basics.',
      ...
      pricingTiers: [
        { id: '1', name: 'Standard', price: 290, description: 'Regular class price', isDefault: true },
        { id: '2', name: 'Student', price: 250, description: 'Student discount available', isDefault: false }
      ],
      discountCodes: [
        { id: '1', code: 'STUDENT10', type: 'percentage', value: 10, description: 'Student discount' }
      ]
    }
  ];
  ...
  const mockEnrolledClasses: ClassData[] = [
    {
      ...
      price: 300,
      status: 'in-progress',
      description: 'Introduction to pottery making covering basic techniques and fundamentals.',
      ...
      pricingTiers: [
        { id: '1', name: 'Standard', price: 300, description: 'Regular price', isDefault: true }
      ],
      discountCodes: [],
      sessions: [
        { id: '1', date: '2025-01-08', time: '6:00-8:00 PM', topic: 'Introduction to Clay', attended: true, notes: 'Great first session! Learned about clay types.' },
        { id: '2', date: '2025-01-10', time: '6:00-8:00 PM', topic: 'Basic Pinch Pots', attended: true, notes: 'Made my first pinch pot.' },
        { id: '3', date: '2025-01-13', time: '6:00-8:00 PM', topic: 'Coil Building', attended: true },
        { id: '4', date: '2025-01-15', time: '6:00-8:00 PM', topic: 'Wheel Introduction', attended: false, notes: 'Missed due to work' },
        { id: '5', date: '2025-01-20', time: '6:00-8:00 PM', topic: 'Centering Practice', attended: true },
        { id: '6', date: '2025-01-22', time: '6:00-8:00 PM', topic: 'Basic Pulling', attended: true },
        { id: '7', date: '2025-01-27', time: '6:00-8:00 PM', topic: 'Trimming Basics', attended: false },
        { id: '8', date: '2025-01-29', time: '6:00-8:00 PM', topic: 'Glazing Workshop', attended: false }
      ],
      enrollment: {
        ...
        paymentStatus: 'paid',
        attendanceRate: 75,
        progressNotes: 'Showing good progress with handbuilding. Needs more practice with wheel throwing.'
      }
    }
  ];
  ...
  const mockCompletedClasses: ClassData[] = [
    {
      ...
      price: 200,
      status: 'completed',
      description: 'A short introduction to ceramic arts covering basic handbuilding techniques.',
      ...
      pricingTiers: [
        { id: '1', name: 'Standard', price: 200, description: 'Workshop price', isDefault: true }
      ],
      discountCodes: [],
      sessions: [
        { id: '1', date: '2024-11-02', time: '10:00 AM-12:00 PM', topic: 'Clay Basics', attended: true },
        { id: '2', date: '2024-11-09', time: '10:00 AM-12:00 PM', topic: 'Pinch Pots', attended: true },
        { id: '3', date: '2024-11-16', time: '10:00 AM-12:00 PM', topic: 'Glazing', attended: true },
        { id: '4', date: '2024-11-23', time: '10:00 AM-12:00 PM', topic: 'Final Projects', attended: true }
      ],
      enrollment: {
        ...
        paymentStatus: 'paid',
        attendanceRate: 100,
        progressNotes: 'Excellent attendance and enthusiasm. Completed all projects successfully.'
      }
    }
  ];
  ...
  const getPaymentStatusBadge = (status: string) => {
    switch (status) {
      case 'paid': return <Badge variant="default" className="bg-green-500"><CheckCircle className="w-3 h-3 mr-1" />Paid</Badge>;
  ...
  const filteredAvailableClasses = mockAvailableClasses.filter(cls => {
    const matchesSearch = cls.name.toLowerCase().includes(classSearchTerm.toLowerCase()) ||
    ...
    const matchesLocation = selectedLocation === 'all' || cls.studioLocation === selectedLocation;
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Discover and enroll in pottery classes from studios in your area</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-muted-foreground">Available Classes</CardTitle>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-muted-foreground">Completed Classes</CardTitle>
      ...
      <Tabs value={activeClassTab} onValueChange={setActiveClassTab} className="space-y-6">
        ...
        <TabsContent value="available" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAvailableClasses.map((classData) => (
              <Card key={classData.id} className="overflow-hidden hover:shadow-md transition-shadow">
                ...
                <CardHeader className="pb-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{classData.studio}</p>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardContent className="pt-0 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-lg font-semibold">${classData.price}</div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-muted-foreground">{classData.instructor} • {classData.studio}</p>
                          <div className="flex items-center space-x-2">
                            {getStatusBadge(classData.status)}
                            {classData.enrollment && getPaymentStatusBadge(classData.enrollment.paymentStatus)}
                          </div>
                        </div>
                      </div>
                      <div className="text-right space-y-2">
                        <div className="text-lg font-semibold">${classData.enrollment?.amountPaid}</div>
                        <Button size="sm" variant="outline" onClick={() => handleViewClassDetails(classData)}>
                          View Details
                        </Button>
                      </div>
                    </div>
                  ...
                  <CardContent className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span>{classData.enrollment?.attendanceRate}%</span>
                          </div>
                          <Progress value={classData.enrollment?.attendanceRate} className="h-2" />
                          <div className="text-xs text-muted-foreground">
                            {classData.sessions?.filter(s => s.attended).length} of {classData.sessions?.length} sessions attended
                          </div>
                        </div>
                      </div>
                    ...
                    {classData.enrollment?.progressNotes && (
                      <div className="p-4 bg-muted rounded-lg">
                        <h5 className="font-medium mb-2">Instructor Notes</h5>
                        <p className="text-sm text-muted-foreground">{classData.enrollment.progressNotes}</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card key={classData.id}>
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right space-y-2">
                        <div className="text-lg font-semibold">100% Complete</div>
                        <Button size="sm" variant="outline" onClick={() => handleViewClassDetails(classData)}>
                          View Certificate
                        </Button>
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {classData.enrollment?.attendanceRate}% attendance rate
                        </p>
                      </div>
                      <div className="space-y-2">
                    ...
                    {classData.enrollment?.progressNotes && (
                      <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                        <h5 className="font-medium mb-2 text-green-900">Final Assessment</h5>
                        <p className="text-sm text-green-700">{classData.enrollment.progressNotes}</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>{mockCompletedClasses.length}/{mockEnrolledClasses.length + mockCompletedClasses.length}</span>
                  </div>
                  <Progress value={(mockCompletedClasses.length / (mockEnrolledClasses.length + mockCompletedClasses.length)) * 100} className="h-2" />
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 p-4 border rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Completed Nov 23, 2024 • 4 weeks</p>
                  </div>
                ...
                <div className="flex items-center space-x-4 p-4 border rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Started Jan 8, 2025 • 8 weeks</p>
                  </div>
                ...
                <div className="flex items-center space-x-4 p-4 border rounded-lg opacity-50">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Planning to enroll • 4 weeks</p>
                  </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{selectedClass.studio}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{selectedClass.startDate}</p>
                </div>
                <div>
                  <Label className="text-sm font-medium">Location</Label>
                  <p className="text-sm text-muted-foreground">{selectedClass.studioLocation}</p>
                </div>
              </div>
                    ...
                    <div key={tier.id} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          ...
                          {tier.isDefault && <Badge variant="secondary">Popular</Badge>}
                        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{selectedClass.materials}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3">
                      <Avatar className="w-12 h-12">
                        ...
                        <AvatarFallback>{getInitials(selectedClass.instructor)}</AvatarFallback>
                      </Avatar>
                      <div>
