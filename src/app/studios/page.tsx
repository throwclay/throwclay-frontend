...
export default function PublicStudiosDirectory({
    ...
    const [selectedLocation, setSelectedLocation] = useState<PublicStudioLocationCard | null>(null);
    const [appMembershipType, setAppMembershipType] = useState<"basic" | "premium" | "unlimited">(
        "basic"
    );
    ...
    useEffect(() => {
        ...
        `
            ...
            if (error) {
                ...
                setLoadError(error.message || "Failed to load studios. Please try again later.");
                setLocations([]);
                setIsLoading(false);
                return;
            }
            ...
            const mapped: PublicStudioLocationCard[] = (data ?? [])
                .map((row: any) => {
                    ...
                    if (studio.plan === "studio-pro" || studio.plan === "studio-unlimited")
                        priceRange = "high";
    ...
    const filteredLocations = locations.filter((loc) => {
        ...
        const matchesLocation = locationFilter === "all" || loc.state === locationFilter;

        const matchesSpecialty =
            specialtyFilter === "all" ||
            loc.specialties.some((s) => s.toLowerCase().includes(specialtyFilter.toLowerCase()));
    ...
    const submitApplication = async () => {
        ...
        try {
            ...
            const res = await fetch(`/api/studios/${selectedLocation.studioId}/applications`, {
                method: "POST",
                headers: {
            ...
            toast.success("Application submitted! The studio will review your request.");
    ...
    const isMemberOfLocation = (locationId: string) => {
        if (!context.currentUser || !context.currentStudio || !context.currentMembership)
            return false;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg mt-4">
                    Discover pottery studios and specific locations, then apply to join the one that
                    fits you best.
                </p>
            </div>
            ...
            >
                <DialogContent className="max-w-lg">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Tell the studio a bit about your experience and what you’re looking for.
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="space-y-4 mt-2">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <Input
                                        value={context.currentUser?.email}
                                        disabled
                                    />
                                </div>
                            </div>
