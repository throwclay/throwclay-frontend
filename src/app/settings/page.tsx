                ...
                >
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Control who can read your blog posts</CardDescription>
                        </CardHeader>
                ...
                >
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Your current Throw Clay subscription</CardDescription>
                        </CardHeader>
                        <CardContent>
                            {currentPlan && (
                                                ...
                                                {domain.status === "active" && (
                                                    <div className="bg-green-50 border border-green-200 rounded p-3 text-sm">
                                                        <p className="text-green-800">
                                                            ...
                                                            Domain is active and redirecting to your
                                                            profile
                                                        </p>
                                                    </div>
                                                )}
                                ...
                                <div className="bg-muted p-4 rounded-lg space-y-2 text-sm">
                                    ...
                                    <ul className="space-y-1 text-muted-foreground">
                                        ...
                                        <li className="flex items-start gap-2">
                                            <ChevronRight className="w-4 h-4 mt-0.5 flex-shrink-0" />
                                            <span>
                                                <strong>Kiln & Glaze:</strong> Manage kiln schedules
                                                and glaze inventory
                                            </span>
                                        </li>
                                        <li className="flex items-start gap-2">
                ...
                >
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Define your brand colors for consistent styling across documents and
                                materials
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Customize your invoice appearance for marketplace sales and custom
                                invoices
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="invoiceHeader">Invoice Header (Optional)</Label>
                                    <Textarea
                                        id="invoiceHeader"
