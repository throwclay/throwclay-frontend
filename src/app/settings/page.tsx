...
export default function Settings() {
  ...
  const handleAddDomain = () => {
    ...
    const domain: CustomDomain = {
      ...
      domain: newDomain,
      status: "pending",
      verificationCode: `TXT-VERIFY-${Math.random()
        .toString(36)
        .substr(2, 9)
        .toUpperCase()}`,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage your{" "}
          {currentUser.activeMode === "studio" ? "studio" : "account"} settings
          and preferences
        </p>
      </div>
      ...
      <Tabs
        defaultValue={
          currentUser.activeMode === "studio" ? "studio" : "profile"
        }
        className="space-y-6"
      >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setNotificationSettings((prev) => ({
                          ...prev,
                          email: { ...prev.email, glazeMixReady: checked },
                        }))
                      }
                    />
                  </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setNotificationSettings((prev) => ({
                      ...prev,
                      email: { ...prev.email, membershipExpiring: checked },
                    }))
                  }
                />
              </div>
              ...
              {currentUser.activeMode === "studio" && (
                <>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      checked={notificationSettings.email.marketplaceApprovals}
                      onCheckedChange={(checked) =>
                        setNotificationSettings((prev) => ({
                          ...prev,
                          email: {
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="billingName" defaultValue={currentUser.name} />
                  </div>
                  <div className="space-y-2">
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <CardDescription>
                      View and download your Throw Clay subscription invoices
                    </CardDescription>
                  </div>
                  <Button variant="outline" size="sm">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-blue-800">
                        ...
                        <li>
                          Wait for verification (usually takes 24-48 hours)
                        </li>
                        <li>
                          Your domain will redirect to your Throw Clay profile
                        </li>
                      </ol>
                    </div>
                  </div>
                        ...
                        {domain.status === "active" && (
                          <div className="bg-green-50 border border-green-200 rounded p-3 text-sm">
                            <p className="text-green-800">
                              ...
                              Domain is active and redirecting to your profile
                            </p>
                          </div>
                        )}
                      </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="w-full bg-muted rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${(customDomains.length / 5) * 100}%` }}
                    />
                  </div>
                  <p className="text-xs text-muted-foreground">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Manage staff roles and their access levels. These roles
                      will be available when adding new staff members.
                    </CardDescription>
                  </div>
                  <Button
                    onClick={() => {
                ...
                <div className="bg-muted p-4 rounded-lg space-y-2 text-sm">
                  ...
                  <ul className="space-y-1 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Dashboard:</strong> View studio overview and
                        analytics
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Classes & Events:</strong> Create and manage
                        classes/events
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Calendar:</strong> View and manage studio
                        calendar
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Kiln & Glaze:</strong> Manage kiln schedules and
                        glaze inventory
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Members & Staff:</strong> Manage member and
                        staff accounts
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Settings:</strong> Full administrative access to
                        studio settings
                      </span>
                    </li>
                  </ul>
              ...
              <div className="space-y-3">
                ...
                >
                  <input
                    ...
                    type="file"
                    accept="image/*"
                    onChange={(e) => handleLogoFileInputChange(e, "primary")}
                    className="hidden"
                  />
                  ...
                  {brandingSettings.logo ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-center space-x-2 text-sm text-green-600 dark:text-green-400">
                        ...
                        <span className="font-medium">
                          {brandingSettings.logoFile?.name || "Logo uploaded"}
                        </span>
                      </div>
                      <Button
                        variant="outline"
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-center">
                        <div
                          className={`rounded-full p-3 ${
                            isDraggingLogo ? "bg-primary/10" : "bg-muted"
                          }`}
                        >
                          <ImageIcon
                            className={`w-6 h-6 ${
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          or click to browse • PNG, SVG, JPG recommended
                        </p>
                      </div>
                    </div>
                  )}
              ...
              <div className="space-y-3">
                ...
                >
                  <input
                    ...
                    type="file"
                    accept="image/*"
                    onChange={(e) => handleLogoFileInputChange(e, "secondary")}
                    className="hidden"
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Clean design with accent colors and bold typography
                      </p>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Traditional business invoice with professional look
                      </p>
                    </div>
                  </div>
                  <div
                    ...
                    {currentUser.activeMode === "studio" && (
                      <>
                        <div className="flex items-center gap-2">
                          <Checkbox
                            id="showStudioInfo"
                            checked={brandingSettings.showStudioInfo}
                            onCheckedChange={(checked) =>
                              setBrandingSettings((prev) => ({
                                ...prev,
                                showStudioInfo: checked as boolean,
                              }))
                            }
                          />
                          <Label
                        ...
                        <div className="flex items-center gap-2">
                          <Checkbox
                            id="showArtistInfo"
                            checked={brandingSettings.showArtistInfo}
                            onCheckedChange={(checked) =>
                              setBrandingSettings((prev) => ({
                                ...prev,
                                showArtistInfo: checked as boolean,
                              }))
                            }
                          />
                          <Label
              ...
              <div className="space-y-3">
                ...
                <InvoicePreview
                  ...
                  settings={{
                    ...
                    invoiceNumberPrefix: brandingSettings.invoiceNumberPrefix,
