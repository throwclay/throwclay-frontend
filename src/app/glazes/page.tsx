...
export default function GlazeManagement() {
                ...
                ingredients: [
                    {
                        ...
                        quantity: 40,
                        unit: "percentage",
                        notes: "High silica for crystal formation"
                    },
                    {
                        ingredientId: "2",
                    ...
                    {
                        ingredientId: "3",
                        ingredientName: "Potash Feldspar",
                        quantity: 20,
                        unit: "percentage"
                    },
                    {
                    ...
                    {
                        ingredientId: "5",
                        ingredientName: "Cobalt Carbonate",
                        quantity: 5,
                        unit: "percentage"
                    }
                ],
                mixingInstructions:
                    "Mix dry ingredients thoroughly, add water slowly to create smooth consistency",
                meshSize: 80
            },
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setGlazeForm((prev) => ({ ...prev, name: e.target.value }))
                                }
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value: "store-bought" | "experiment") =>
                                    setGlazeForm((prev) => ({ ...prev, type: value }))
                                }
                            >
                                <SelectTrigger>
                                    <SelectValue />
    ...
    if (currentView === "editor") {
        return <div className="max-w-6xl mx-auto p-8">{renderEditor()}</div>;
    }
        ...
        <div className="max-w-7xl mx-auto p-8 space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-lg">
                        Track glazes, experiments, and photo documentation
                    </p>
                </div>
                <div className="flex items-center space-x-3">
                    <Button
                                    ...
                                    <TableRow key={glaze.id}>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <Button
                                                    variant="ghost"
                                                    size="sm"
                                                    onClick={() => handleAddPhoto(glaze.id)}
                                                >
                                        ...
                                        <TableCell>
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent>
                                                    <DropdownMenuItem
                                                        onClick={() => handleEditGlaze(glaze.id)}
                                                    >
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center space-x-2 text-sm">
                                            ...
                                            <span>
                                                {new Date(experiment.testDate).toLocaleDateString()}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div className="text-center py-16 space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-muted-foreground">
                                    Start documenting your glazes by adding photos to capture
