...
export default function Home() {
    ...
    const handleLogin = async (userData: {
        ...
        context.setAuthToken(userData.session.access_token);
        ...
        if (membershipError) {
            console.error(
                "handleLogin: error fetching memberships",
                membershipError
            );
        }
        if (subError) {
        ...
        const appUser: UserType = {
            ...
            profile: {
                ...
                branding: {
                    primaryColor:
                        (profileRow as any)?.branding?.primaryColor ??
                        "#030213",
                    secondaryColor: (profileRow as any)?.branding
                        ?.secondaryColor,
        ...
        appUser.availableModes = hasStudioRole
            ? ["artist", "studio"]
            : ["artist"];
        ...
        setIsLoggedIn(true);
        setCurrentPage(
            appUser.activeMode === "studio" ? "dashboard" : "profile"
        );
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-xl text-muted-foreground max-w-lg">
                                            Manage your studio, document your
                                            ceramic journey, connect with
                                            artists, and sell your work — all in
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="text-center space-y-8">
                                <p className="text-muted-foreground">
                                    Trusted by pottery studios and ceramic
                                    artists worldwide
                                </p>
                                    ...
                                    <div className="flex flex-col items-center justify-center space-y-3">
                                        <div className="flex items-center space-x-3">
                                            <div
                                                ...
                                                style={{
                                                    borderRadius:
                                                        "45% 55% 65% 35% / 70% 30% 70% 30%",
                                                }}
                                            >
                                                <div
                                                    className="w-3 h-5 bg-white opacity-90"
                                                    style={{
                                                        borderRadius:
                                                            "50% 50% 0 0",
                                                    }}
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="text-center space-y-4 mb-16">
                                ...
                                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                                    Whether you're running a studio or creating
                                    as an independent artist, Throw Clay has the
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                <Card className="p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <CardContent className="p-0">
                                        <p className="text-muted-foreground mb-4">
                                            Complete studio operations with
                                            member management, class scheduling,
                                            firing calendars, and staff
                                            coordination.
                                        </p>
                                ...
                                <Card className="p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <CardContent className="p-0">
                                        <p className="text-muted-foreground mb-4">
                                            Document your ceramic journey with
                                            photos, sketches, notes, and
                                            detailed project tracking with our
                                ...
                                <Card className="p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <CardContent className="p-0">
                                        <p className="text-muted-foreground mb-4">
                                            Showcase your work with beautiful,
                                            customizable portfolios and connect
                                            with other artists and potential
                                            customers.
                                        </p>
                                        <ul className="space-y-2 text-sm">
                                            <li className="flex items-center space-x-2">
                                ...
                                <Card className="p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <CardContent className="p-0">
                                        <p className="text-muted-foreground mb-4">
                                            Sell your ceramic pieces through
                                            integrated marketplace with built-in
                                ...
                                <Card className="p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <CardContent className="p-0">
                                        <p className="text-muted-foreground mb-4">
                                            Stay connected with integrated
                                            messaging, class discussions,
                    ...
                    <section className="py-24">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="text-center space-y-4 mb-16">
                                ...
                                <p className="text-xl text-muted-foreground">
                                    Hear from studios and artists using Throw
                                    Clay
                                </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                <Card className="p-6">
                                    <CardContent className="p-0">
                                        ...
                                        <p className="text-muted-foreground mb-4">
                                            "Throw Clay has revolutionized how
                                            we manage our studio. The firing
                                            coordination and member management
                                            features have saved us countless
                                            hours."
                                        </p>
                                        <div className="flex items-center space-x-3">
                                ...
                                <Card className="p-6">
                                    <CardContent className="p-0">
                                        ...
                                        <p className="text-muted-foreground mb-4">
                                            "The digital journal is incredible.
                                            I can document my entire ceramic
                                            journey with photos and notes. The
                                            whiteboard mode is a game-changer."
                                        </p>
                                        <div className="flex items-center space-x-3">
                                ...
                                <Card className="p-6">
                                    <CardContent className="p-0">
                                        ...
                                        <p className="text-muted-foreground mb-4">
                                            "Our students love the portfolio
                                            features and being able to track
                                            their progress. It's helped build a
                                            stronger community around our
                                            studio."
                                        </p>
                                        <div className="flex items-center space-x-3">
                    ...
                    <section className="py-24 bg-primary/5">
                        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                            <div className="space-y-8">
                                ...
                                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                                    Join thousands of studios and artists who
                                    are already using Throw Clay to manage their
                                    pottery practice and grow their business.
                                </p>
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="grid md:grid-cols-4 gap-8">
                                <div className="space-y-4">
                                    ...
                                    <p className="text-muted-foreground">
                                        The complete platform for pottery
                                        studios and ceramic artists.
                                    </p>
                                </div>
                            ...
                            <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
                                <p>
                                    &copy; 2024 Throw Clay. All rights reserved.
                                </p>
                            </div>
                        </div>
                    </footer>
