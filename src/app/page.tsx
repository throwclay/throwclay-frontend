                        ...
                        <div className="space-y-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-xl text-muted-foreground max-w-lg">
                                    Manage your studio, document your ceramic journey, connect with
                                    artists, and sell your work — all in one powerful platform.
                                </p>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center space-y-4 mb-16">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            Whether you're running a studio or creating as an independent artist,
                            Throw Clay has the tools you need to succeed.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Card className="p-6 hover:shadow-lg transition-shadow">
                            ...
                            <CardContent className="p-0">
                                <p className="text-muted-foreground mb-4">
                                    Document your ceramic journey with photos, sketches, notes, and
                                    detailed project tracking with our innovative whiteboard
                                    interface.
                                </p>
                                <ul className="space-y-2 text-sm">
                                    <li className="flex items-center space-x-2">
                        ...
                        <Card className="p-6 hover:shadow-lg transition-shadow">
                            ...
                            <CardContent className="p-0">
                                <p className="text-muted-foreground mb-4">
                                    Showcase your work with beautiful, customizable portfolios and
                                    connect with other artists and potential customers.
                                </p>
                                <ul className="space-y-2 text-sm">
                                    <li className="flex items-center space-x-2">
                                        <CheckCircle className="w-4 h-4 text-green-500" />
                        ...
                        <Card className="p-6">
                            <CardContent className="p-0">
                                ...
                                <p className="text-muted-foreground mb-4">
                                    ...
                                    firing coordination and member management features have saved us
                                    countless hours."
                                </p>
                                <div className="flex items-center space-x-3">
                        ...
                        <Card className="p-6">
                            <CardContent className="p-0">
                                ...
                                <p className="text-muted-foreground mb-4">
                                    ...
                                    ceramic journey with photos and notes. The whiteboard mode is a
                                    game-changer."
                                </p>
                                <div className="flex items-center space-x-3">
            ...
            <section className="py-24 bg-primary/5">
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <div className="space-y-8">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            Join thousands of studios and artists who are already using Throw Clay
