...
Remember, patience is key. Most beginners struggle with centering, but with practice, it becomes second nature.`,
            excerpt:
                "Learn the fundamentals of wheel throwing with our comprehensive beginner's guide covering centering, opening, and pulling techniques.",
            ...
            seoDescription:
                "Master wheel throwing with our step-by-step guide. Learn centering, opening, and pulling techniques from professional potters.",
...
- **Pinholing**: Typically caused by thick application or rapid firing`,
            excerpt:
                "Dive deep into glaze chemistry and learn how to troubleshoot common glazing problems for perfect ceramic finishes.",
            authorId: currentUser?.id || "user_1",
            authorName: currentUser?.name || "Studio Admin",
            authorHandle: currentUser?.handle || "studio",
            authorAvatar: currentUser?.profile?.profileImage,
            ...
            featuredImage:
                "https://images.unsplash.com/photo-1465408953385-7c4627c2d4a6?w=800&h=400&fit=crop",
...
"Don't give up after the first few sessions," Sarah advises. "Pottery is a practice that rewards patience and persistence. Every 'failure' teaches you something important."`,
            excerpt:
                "Meet Sarah Martinez, a dedicated student whose pottery journey from complete beginner to accomplished ceramic artist inspires us all.",
            authorId: currentUser?.id || "user_1",
            authorName: currentUser?.name || "Studio Admin",
            authorHandle: currentUser?.handle || "studio",
            authorAvatar: currentUser?.profile?.profileImage,
            ...
            featuredImage:
                "https://images.unsplash.com/photo-1543254382-96cd0c0b8746?w=800&h=400&fit=crop",
    ...
    const handleStatusChange = (postId: string, newStatus: BlogPost["status"]) => {
        ...
        toast.success(
            `Post ${newStatus === "published" ? "published" : `moved to ${newStatus}`} successfully!`
        );
    };
