...
export async function GET(
  ...
  try {
    ...
    if (error || !data) {
      console.error(
        "GET /api/admin/studios/[studioId]/kilns/[kilnId] fetch error",
        error
      );
...
export async function DELETE(
  ...
  try {
    ...
    if (error) {
      console.error("DELETE /api/admin/studios/[studioId]/kilns/[kilnId] delete error", error);
      return NextResponse.json(
        { error: "Failed to delete kiln" },
        { status: 500 }
      );
    }
