    ...
    try {
      ...
      `
        ...
        if (error || !data) {
            ...
            return NextResponse.json({ error: "Firing not found" }, { status: 404 });
        }
        ...
        return NextResponse.json({ error: "Failed to load firing" }, { status: 500 });
    }
}
...
export async function PUT(
    ...
    try {
        ...
        if (error || !data) {
            console.error(
                "PUT /api/admin/studios/[studioId]/kiln-firings/[firingId] update error",
                error
            );
            return NextResponse.json({ error: "Failed to update firing" }, { status: 500 });
        }
...
export async function DELETE(
    ...
    try {
        ...
        if (error) {
            console.error(
                "DELETE /api/admin/studios/[studioId]/kiln-firings/[firingId] delete error",
                error
            );
            return NextResponse.json({ error: "Failed to delete firing" }, { status: 500 });
        }
